...
<?php
    ...
    $sps = $db->executeReader("SELECT tbl_sanpham.*, tbl_giacapnhat.Gia, tbl_giasanpham.* FROM tbl_sanpham, tbl_giasanpham, tbl_giacapnhat WHERE tbl_sanpham.Ma = tbl_giasanpham.MaSanPham and tbl_giasanpham.MaGia = tbl_giacapnhat.Ma and tbl_giacapnhat.NgayHetHieuLuc is null and Search like '%".$search."%' ");
?>
